...
<script defer src="<?=backend_js_url()?>/mylibs/jquery.dataTables.min.js"></script> <!-- Tables -->
<script defer src="<?=backend_js_url()?>/mylibs/jquery.tipsy.js"></script> <!-- Tooltips -->
<script defer src="<?=backend_js_url()?>/mylibs/excanvas.js"></script> <!-- Charts -->
<script defer src="<?=backend_js_url()?>/mylibs/jquery.visualize.js"></script> <!-- Charts -->
